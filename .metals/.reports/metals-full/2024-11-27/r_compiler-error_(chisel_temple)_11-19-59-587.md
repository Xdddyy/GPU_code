...
### java.lang.StringIndexOutOfBoundsException: offset 1348, count -9, length 1462
...
cache_line_number:Int=512,data_block_size:Int=1024,width: Int=8,numRead: Int=2, numWrite: Int=2, numReadwrite: Int=2) extends Module{
    ...
    val valid   = RegInit()@@
    val dirty   = Reg(Vec(cache_line_number,Bool()))
    val tag     = Reg(Vec(cache_line_number,UInt()))
