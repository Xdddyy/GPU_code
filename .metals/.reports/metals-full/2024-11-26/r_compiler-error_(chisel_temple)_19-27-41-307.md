file://<WORKSPACE>/src/main/scala/SRAM/sram.scala
### scala.reflect.internal.FatalError: no context found for source-file://<WORKSPACE>/src/main/scala/SRAM/sram.scala,line-1,offset=14
...
action parameters:
offset: 14
uri: file://<WORKSPACE>/src/main/scala/SRAM/sram.scala
text:
```scala
//此文件主要用于SRAM相@@关模设计
